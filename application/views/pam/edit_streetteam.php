<?php
  if( count($team_num) == 0 ){
    $team_num = array(array('P_1'=>0,'P_2'=>0,'P_3'=>0,'P_4'=>0,'P_5'=>0,'P_6'=>0,'P_7'=>0,'P_8'=>0,'P_9'=>0,'P_10'=>0,'P_11'=>0,'P_12'=>0));
  }// end if
  if( count($team_sal) == 0 ){
    $team_sal = array(array('P_1'=>0,'P_2'=>0,'P_3'=>0,'P_4'=>0,'P_5'=>0,'P_6'=>0,'P_7'=>0,'P_8'=>0,'P_9'=>0,'P_10'=>0,'P_11'=>0,'P_12'=>0));
  }// end if
?><!DOCTYPE html>
<html lang="en">
<head>
	...
	<title>P.A.M. -- Edit Street Team Employees</title>
  ...
  <style>
    #control_panel{ position:fixed; bottom:0;}th{text-align:left;}
  </style>
    ...
    <div class="row">
      <div class="span12">
        <div class="row" style="text-align:center;">
          <h1>STREET TEAM EMPLOYEES</h1>
        </div> <!-- END .row -->
        <div class="row">
          <?php //print_r($budget); ?>
          <br><br>
          <?= form_open('pam_budget/edit_streetteam_handler'); ?>
          <table style="width:50%;margin:0 auto;">
            ...
            <?php for($f=1;$f<13;$f++): ?>
            <?php 
              $num_input = array('name'=>'num_P_'.$f,'id'=>'num_P_'.$f,'value'=>$team_num[0]['P_'.$f],'size'=>'30','style'=>'width:50px;text-align:center;');
              $sal_input = array('name'=>'sal_P_'.$f,'id'=>'sal_P_'.$f,'value'=>$team_sal[0]['P_'.$f],'size'=>'70','style'=>'width:120px;text-align:right;');
              $btnCancel = array('name'=>'btnCancel','id'=>'btnCancel','value'=>'Cancel','class'=>'btn');
              $btnSubmit = array('name'=>'btnSubmit','id'=>'btnSubmit','value'=>'Save Street Team','class'=>'btn btn-edr');
             ?>
              <tr>
              ...
              <tr>
                <td colspan="3">
                  ...
                  <button type="submit" class="btn btn-edr" name="btnSubmit" id="btnSubmit">
                    <i class="icon-ok icon-white"></i> Save Street Team
                  </button>  
                </td>
              </tr>
          </table>
