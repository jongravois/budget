...
<html>
	...
	<body>
		<table cellpadding="5px" style="background-color:#FFFFFF;width:60%;margin:0 auto;">
			...
			<tr>
				<td align="left">
					User: <strong><?= strtoupper($user->username); ?></strong> has submitted the Payroll portion of the 20<?= $this->globals_m->current_year(); ?> Budget for <strong><?= $budget[0]['name']; ?></strong> for approval on <?= date('l, F d, Y'); ?>.
				</td>
			</tr>
		</table>
	</body>
