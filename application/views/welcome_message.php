...
<body>
  ...
  <div class="row">
    <div class="span12">
      <h3>Welcome to PAM IV</h3>
      <p class="head_link btn" style="text-align:center;">
        <a href="<?php echo site_url('welcome/sam'); ?>">SWITCH TO SAM IV</a>
      </p>
    </div>
  </div>
  <hr>
    ...
    <div class="row">
      <div class="span12">
        <div class="row">
          <ul class="unstyled">
            <li class="span4">
              <form class="pmDemo" action="<?= site_url('pam_user/index'); ?>" method="post">
