...
?>
	<td colspan='8' style='background-color:#FFFFFF;'>
		...
		<table class='table table-bordered sam-sub-main' style='width:80%; margin:0 auto;'>
			...
			<tr class="rowNewForm">
				<?php
					$assetDD = $this->sam_m->get_new_asset_dd($primary->id);
				?>
				<td colspan="4" style="background-color: #1b6633;"><br>
					...
					<table class='table table-bordered' style='width:100%; margin:0 auto;'>
						...
						<tr style="background-color:#1b6633;color:#FFF;">
							<td style="width:22%;">Asset</td>
							<td style="width:12%;">Type</td>
							<td style="width:39%;">Description</td>
							<td style="width:15%;">Project Code</td>
							<td style="width:12%;">Project Total</td>
						</tr>
						<tr style="background-color:#FFF;">
							<td>
								<?= form_dropdown('ASSET_ID', $assetDD, '0', 'id="newProjectAssetID" class="span2"'); ?>
							</td>
							<td><span id="newProjectType"></span></td>
							<td>
								<input type="text" class="span4" id="sam_description" name="sam_description" />
							</td>
							<td><span id="newProjectCode"></span></td>
							<td>
