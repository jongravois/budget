		...
		<?php foreach($atm as $row): ?>
			...
			<tr class="major_values_row">
				...
				<?php if( $primary->atm_status == 1): ?>
					<a class="btn btn-inverse btnEditTimeline"><i class="icon-th"></i>  Edit A.T.M.</a>
				<?php else: ?>
					<a class="btn btn-inverse btnShowTimeline"><i class="icon-check"></i>  Show A.T.M.</a>
				<?php endif; ?>
				&nbsp;
				<?php if($row['20' . $current_year ] != 0 || $row['20' . $current_year ] != '' ): ?>
					<?php if( $primary->sam_status == 1): ?>
						<a class="btn btn-edr btnEditBudget"><i class="icon-edit"></i> Edit Budget</a>
					<?php else: ?>
						<a class="btn btn-edr btnShowBudget"><i class="icon-edit"></i> Show Budget</a>
					<?php endif; ?>
				<?php endif; ?>
				</td>
			</tr>
