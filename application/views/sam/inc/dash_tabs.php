          ...
          <div id="tabs">
            ...
            <?php
              ...
              switch( $user['accessLevel']){
                case 'admin':
            ?>
              <div id="tabs-1"><?php $this->load->view('sam/inc/dash_panel', $norm); ?></div>
              <div id="tabs-2"><?php $this->load->view('sam/inc/dash_panel', $other); ?></div>
              <div id="tabs-3"><?php $this->load->view('sam/inc/dash_panel', $depts); ?></div>
            <?php
                  break;
                case 'propadmin':
                case 'regional':
            ...
            <?php
                ...
                case 'approver':
            ?>
              <div id="tabs-1"><?php $this->load->view('sam/inc/dash_panel', $depts); ?></div>
            <?php
                  break;
              } // end switch
            ?>
