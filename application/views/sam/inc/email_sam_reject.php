...
<html>
	...
	<body>
		<table cellpadding="5px" style="background-color:#FFFFFF;width:60%;margin:0 auto;">
			...
			<tr>
				<td align="left">
					The Fixed Assets Management portion of the 20<?= $this->globals_m->current_year(); ?> Budget for <strong><?= $budget[0]['name']; ?></strong>  has been rejected. The reason(s) for rejection:
				</td>
			</tr>
			<tr>
				<td align="left">
