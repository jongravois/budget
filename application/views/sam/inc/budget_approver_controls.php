<?php if( (int)$primary->atm_status != 2): ?>
...
<?php else: ?>
	<table cellpadding="6" style="width:100%;">
		<tr style="background-color:#404040; height:40px;">
			...
			<td align="center" style="width:33%;">
				<a href="<?= site_url('pam_budget/z_budget_rejected/'.$primary->id); ?>" class="btn btn-danger"><i class="icon-thumbs-down"></i> REJECT BUDGET</a>
			</td>
		</tr>
	</table>
<?php endif; ?>